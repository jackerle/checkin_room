...
function Input_search({
    ...
    return (
        ...
        <form >
            <div class="row p-3 shadow rounded " data-toggle="collapse" style={{ backgroundColor: "#ededeb" }} >
            ...
            <div class="row p-3 shadow rounded " data-toggle="collapse" style={{ backgroundColor: "#ededeb" }} >
                ...
                <div class="col-2">
                    <input type="text" class="form-control" placeholder="ใส่รหัสวิชา"  onChange={handle_class_id}/>
                </div>
                <div class="col-6">
                    <input type="text" class="form-control" placeholder="ใส่ชื่อวิชา" onChange={handle_class_name}/>
                </div>
            </div>
